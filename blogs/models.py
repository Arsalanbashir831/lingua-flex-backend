...
class Blog(models.Model):
    ...
    thumbnail = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="URL or path to thumbnail image",
    )

    tags = models.JSONField(
        default=list, blank=True, help_text="List of tags for the blog"
    )
    ...
    published_at = models.DateTimeField(
        null=True, blank=True, help_text="When the blog was published"
    )
