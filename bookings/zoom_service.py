    ...
    def update_meeting(self, meeting_id, booking):
        ...
        try:
            ...
            if response.status_code == 204:
                ...
                logger.error(
                    f"Failed to update Zoom meeting {meeting_id}: {response.status_code} - {response.text}"
                )
                return False
    ...
    def delete_meeting(self, meeting_id):
        ...
        try:
            ...
            if response.status_code == 204:
                ...
                logger.error(
                    f"Failed to delete Zoom meeting {meeting_id}: {response.status_code} - {response.text}"
                )
                return False
    ...
    def get_meeting_info(self, meeting_id):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(
                    f"Failed to get Zoom meeting info {meeting_id}: {response.status_code} - {response.text}"
                )
                return None
    ...
    def list_meetings(self, user_email, page_size=30):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(
                    f"Failed to list meetings for {user_email}: {response.status_code} - {response.text}"
                )
                return None
